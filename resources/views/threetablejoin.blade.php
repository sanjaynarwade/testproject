...
<th aria-label="Status: activate to sort column ascending" style="width: 112px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Subject</th>
<th aria-label="Status: activate to sort column ascending" style="width: 112px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Teacher</th>
							  	</tr>
						  </thead>   
					  	...
					  	<tr class="odd">
					  		<td class=" sorting_1">{{$row->id}}</td>
								...
								<td class="center ">{{$row->phone}}</td>
							      <td class="center ">{{$row->subject_name}}</td>
