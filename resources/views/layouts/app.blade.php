...
<body>
                        ...
                        <!-- start: User Dropdown -->
                          @guest
                             ...
                             <script type="text/javascript">
                               ...
                               ///  window.location.href = "http://localhost/newproject/";
                             </script>
            ...
            <div id="sidebar-left" class="span2">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a href="{{URL::to('all_contact')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> View Contact</span></a></li>
                          <li><a href="{{URL::to('all_data')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Data</span></a></li>
                           <li><a href="{{URL::to('threetablejoin')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Three table Data</span></a></li>
    ...
    <script src="{{asset('public/js/jquery-migrate-1.0.0.min.js')}}"></script>
        ...
        <script src="{{asset('public/js/jquery.dataTables.min.j')}}"></script>
